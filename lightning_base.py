...
class BaseTransformer(pl.LightningModule):
    def __init__(
        ...
        **config_kwargs
        ...
        setattr(self.config, 'adapter_dim', getattr(self.hparams, 'adapter_dim'))
    ...
    def configure_optimizers(self):
        ...
        rank_zero_info('params %s', params_name)
        rank_zero_info('params_nodecay %s', params_nodecay_name)
        ...
        rank_zero_info("number of parameters: %s (%.3f)", num_params, num_params/pytorch_total_params)
