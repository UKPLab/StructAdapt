...
This repository contains the code for the EMNLP 2021 paper ["Structural Adapters in Pretrained Language Models for AMR-to-Text Generation"](https://arxiv.org/pdf/2103.09120.pdf). Please star the repository and cite the paper if you find it useful. 
