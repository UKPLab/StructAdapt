...
class SummarizationModule(BaseTransformer):
    ...
    def _step(self, batch: dict) -> Tuple:
        ...
        outputs = self(src_ids, attention_mask=src_mask, decoder_input_ids=decoder_input_ids, use_cache=False, graphs=batch["graphs"])
        lm_logits = outputs[0]
    ...
    def validation_epoch_end(self, outputs, prefix="val") -> Dict:
        ...
        if "preds" in outputs[0]:
            output_test_predictions_file = os.path.join(self.hparams.output_dir, val_outputs_folder, "pred_" +
                                                        str(self.step_count) + ".txt")
            output_test_targets_file = os.path.join(self.hparams.output_dir, val_outputs_folder, "tgt_" +
                                                        str(self.step_count) + ".txt")
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument("--adapter_dim", type=int, default=1024, required=False, help="")
